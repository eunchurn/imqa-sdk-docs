...
description: IMQA Android SDK v1.1.2 설치 및 설정 방법을 안내합니다.
nav: 411
pdf: true
cover: android
---
...
```groovy
dependencies {
  implementation 'io.imqa:imqa-android-sdk:1.1.2'
}
```
...
```groovy
dependencies {
  implementation files('libs/imqa-android-sdk-1.1.2-release.aar')
}
```
...
```groovy
dependencies {
  implementation files('libs/imqa-android-sdk-1.1.0-release.aar') //IMQA SDK
  //IMQA SDK Extensions 추가
  implementation files('libs/imqa-android-sdk-extensions-1.0.0-release.aar') 
  //implementation 'io.imqa:imqa-android-sdk-extensions:1.0.0' //Maven 사용시 
}
```
