...
description: IMQA Android SDK v1.0.15 설치 및 설정 방법을 안내합니다.
nav: 410
pdf: true
...
```groovy
dependencies {
  implementation 'io.imqa:imqa-android-sdk:1.0.15'
}
```
...
```groovy
dependencies {
  implementation files('libs/imqa-android-sdk-1.0.15-release.aar')
}
```
...
### 3. HttpInterceptor 설정

XHR 데이터를 수집하기 위해 `io.imqa.sdk.network.interceptor.HttpInterceptor`를 설정해야 합니다.
