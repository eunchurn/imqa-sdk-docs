...
description: IMQA Android SDK v1.0.19 설치 및 설정 방법을 안내합니다.
nav: 410
pdf: true
...
```groovy
dependencies {
  implementation 'io.imqa:imqa-android-sdk:1.0.19'
}
```
...
```groovy
dependencies {
  implementation files('libs/imqa-android-sdk-1.0.19-release.aar')
}
```
