...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(
        ...
        let option = IMQA.Options(
            ...
            endpoints: endpoint,
            sampleRate: 1.0,
            isDeviceIdEnable: true, //기기 ID 활성화 여부 (선택 사항, 기본값: true
            onOffSDKUrl: "",        //sdk 수집여부 api url 입력 (선택 사항 기본값: "" -> 수집함)
            namespace: "namespace", //namespace (대시보드에 서비스추가시 입력한 namespace를 추가해주세요
            deployEnvironment: .development //배포 환경 설정 (선택 사항, 기본값: .production
        )
...
- (BOOL)application:(UIApplication *)application 
    ...
    IMQAOptions * options = [[IMQAOptions alloc] 
        ...
        onOffSDKUrl: ""  //sdk 수집여부 api url 입력 (선택 사항 기본값: "" -> 수집함)
        namespace: "namespace" //namespace (대시보드에 서비스추가시 입력한 namespace를 추가해주세요
        deployEnvironment: IMQADeployEnvironment.development //배포 환경 설정 (선택 사항, 기본값: .production
        isDeviceIdEnable:YES]; //기기 ID 활성화 여부 (선택 사항, 기본값: true
