...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    IMQAEndpoints *endpoints = [[IMQAEndpoints alloc] initWithCollectorURL:@"collector 주소"];
    IMQAOptions *options = [[IMQAOptions alloc] initWithServiceKey:@"서비스키" endpoints:endpoints sampleRate:1.0];
