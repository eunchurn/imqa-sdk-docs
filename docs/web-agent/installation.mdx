...
<Gha keyword="WARNING" title="IMQA Mobile SDK와 연동">
  <ul>
    ...
    <li>- 반면, 웹 브라우저 환경을 계측할 경우에는 `collectorUrl` 값을 반드시 입력해야 합니다.</li>
  </ul>
</Gha>
...
<Gha keyword="WARNING" title="IMQA Mobile SDK와 연동">
  <ul>
    ...
    <li>- 반면, 웹 브라우저 환경을 계측할 경우에는 `serviceName` 값을 반드시 입력해야 합니다.</li>
  </ul>
</Gha>
...
<Gha keyword="WARNING" title="IMQA Mobile SDK와 연동">
  <ul>
    ...
    <li>- 반면, 웹 브라우저 환경을 계측할 경우에는 `serviceKey` 값을 반드시 입력해야 합니다.</li>
  </ul>
</Gha>
...
<Gha keyword="WARNING" title="IMQA Mobile SDK와 연동">
  <ul>
    ...
    <li>- 반면, 웹 브라우저 환경을 계측할 경우에는 `serviceVersion` 값을 반드시 입력해야 합니다.</li>
  </ul>
</Gha>
