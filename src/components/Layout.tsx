...
export function LayoutHeader({ className, ...props }: ComponentProps<'header'>) {
  return <header className={cn('sticky top-0 bg-surface/95 grid-in-h', className)} {...props} />
}
  ...
  return (
    <nav
      className={cn(
        ...
        'sticky top-[--header-height] h-[calc(100dvh-var(--header-height))] pb-8 grid-in-n',
        className,
      )}
      {...props}
    />
  ...
  return (
    <aside
      className={cn(
        ...
        'sticky top-[--header-height] h-[calc(100dvh-var(--header-height))] pb-8 pr-2 grid-in-t',
        className,
      )}
      {...props}
    />
